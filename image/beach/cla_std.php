...
<span class=\"malemodre\">Vyd�no dne ".$GLOBALS["clanek"]->Ukaz("datum")." (".$GLOBALS["clanek"]->Ukaz("visit")." p�e�ten�)</span><br /><br />
".$GLOBALS["clanek"]->Ukaz("uvod")."<br /><br />
Autor: <a href=\"".$GLOBALS["clanek"]->Ukaz("autor_mail")."\">".$GLOBALS["clanek"]->Ukaz("autor_jm")."</a> |
<a href=\"comment.php?akce=view&cisloclanku=".$GLOBALS["clanek"]->Ukaz("link")."\">Koment��e</a>: ".$GLOBALS["clanek"]->Ukaz("pocet_kom") ." |
<a href=\"comment.php?akce=new&cisloclanku=".$GLOBALS["clanek"]->Ukaz("link")."\">P�idat koment��</a> |
...
<a href=\"search.php?rsvelikost=uvod&rstext=all-phpRS-all&rstema=".$GLOBALS["clanek"]->Ukaz("tema_id")."\"><img src=\"".$GLOBALS["clanek"]->Ukaz("tema_obr")."\" border=\"0\" align=\"right\" /></a>
<img src=\"image/beach/bullet.gif\" border=\"0\" hspace=\"3\" /> <span class=\"clanadpis\">".$GLOBALS["clanek"]->Ukaz("titulek")."</span><br />
<span class=\"malemodre\">Vyd�no dne ".$GLOBALS["clanek"]->Ukaz("datum")." (".$GLOBALS["clanek"]->Ukaz("visit_plus")." p�e�ten�)</span><br /><br />
...
echo "Autor: <a href=\"".$GLOBALS["clanek"]->Ukaz("autor_mail")."\">".$GLOBALS["clanek"]->Ukaz("autor_jm")."</a> |
<a href=\"comment.php?akce=view&cisloclanku=".$GLOBALS["clanek"]->Ukaz("link")."\">Koment��e</a>: ".$GLOBALS["clanek"]->Ukaz("pocet_kom")." |
<a href=\"comment.php?akce=new&cisloclanku=".$GLOBALS["clanek"]->Ukaz("link")."\">P�idat koment��</a> |
