...
<span class=\"z1\">Vystaveno: ".$GLOBALS["clanek"]->Ukaz("datum")." | pøímý náhled... </span><br /><br />
<span class=\"z2\">".$GLOBALS["clanek"]->Ukaz("uvod")."</span><br />
<span class=\"z1\">Vložil: <a href=\"".$GLOBALS["clanek"]->Ukaz("autor_mail")."\">".$GLOBALS["clanek"]->Ukaz("autor_jm")."</a> |
<a href=\"comment.php?akce=view&amp;cisloclanku=".$GLOBALS["clanek"]->Ukaz("link")."\">Komentáøù</a>: ".$GLOBALS["clanek"]->Ukaz("pocet_kom") ." |
...
alt=\"Informaèní e-mail\" /></a><a href=\"rservice.php?akce=tisk&amp;cisloclanku=".$GLOBALS["clanek"]->Ukaz("link")."\" target=\"_blank\"><img src=\"image/freestyle/printer.gif\" height=\"22\" width=\"20\" border=\"0\" hspace=\"0\" vspace=\"1\" align=\"absmiddle\" alt=\"Vytisknout èlánek\" /></a><br />
</span></td></tr></table>
</div>
\n";
// --------------------------------- [konec - kratky clanek] ---------------------------------
...
<span class=\"z1\">Vydáno dne ".$GLOBALS["clanek"]->Ukaz("datum")." | pøeèteno: ".$GLOBALS["clanek"]->Ukaz("visit")."x</span><br /><br />
<span class=\"z2\">".$GLOBALS["clanek"]->Ukaz("uvod")."</span><br /><br />
<span class=\"z1\"><a href=\"view.php?cisloclanku=".$GLOBALS["clanek"]->Ukaz("link")."\"><b>Více informací>>></b></a> |
Vložil: <a href=\"".$GLOBALS["clanek"]->Ukaz("autor_mail")."\">".$GLOBALS["clanek"]->Ukaz("autor_jm")."</a> |
<a href=\"comment.php?akce=view&amp;cisloclanku=".$GLOBALS["clanek"]->Ukaz("link")."\">Komentáø:</a> ".$GLOBALS["clanek"]->Ukaz("pocet_kom") ."x <br />
</td></tr></table>
</div>
\n";
...
echo "<span class=\"z1\">Èlánek otevøen! | Vložil: <a href=\"".$GLOBALS["clanek"]->Ukaz("autor_mail")."\">".$GLOBALS["clanek"]->Ukaz("autor_jm")."</a> |
<a href=\"comment.php?akce=view&amp;cisloclanku=".$GLOBALS["clanek"]->Ukaz("link")."\">Komentováno:</a> ".$GLOBALS["clanek"]->Ukaz("pocet_kom")."x |
<a href=\"comment.php?akce=new&amp;cisloclanku=".$GLOBALS["clanek"]->Ukaz("link")."\">Komentuj!</a> |
<a href=\"rservice.php?akce=info&amp;cisloclanku=".$GLOBALS["clanek"]->Ukaz("link")."\" target=\"_blank\"><img src=\"image/freestyle/mail.gif\" height=\"22\" width=\"20\" border=\"0\" hspace=\"0\" vspace=\"1\" align=\"absmiddle\"
alt=\"Informaèní e-mail\" /></a><a href=\"rservice.php?akce=tisk&amp;cisloclanku=".$GLOBALS["clanek"]->Ukaz("link")."\" target=\"_blank\"><img src=\"image/freestyle/printer.gif\" height=\"22\" width=\"20\" border=\"0\" hspace=\"0\" vspace=\"1\" align=\"absmiddle\" alt=\"Vytisknout èlánek\" /></a> ";
...
echo "| <b><a href=\"index.php\">Zavøít èlánek>>></a></b><br />
</td></tr></table>
</div>
<p></p>\n";
